  ...
  return (
    <main className="relative mx-auto max-w-4xl px-6 py-10">
      ...
      <section id="home" className="py-12">
        <p className="text-[10px] uppercase tracking-widest text-muted-foreground">Hello, I'm</p>
        <h1 className="mt-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-3xl font-extrabold text-transparent md:text-4xl">
          Vibhav Kaluvala
        </h1>
      ...
      <section id="experience" className="scroll-mt-24 py-10">
        <h2 className="mb-6 text-lg font-semibold">Experience</h2>
